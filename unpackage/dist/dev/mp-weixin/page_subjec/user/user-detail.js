              ...
              common_vendor.wx$1.showModal({
                ...
                success: (res2) => {
                  if (res2.confirm) {
                    ...
                    utils_js_api.uniRequest("POST", "modify_user_profile_img", data, "user", (res3) => {
                      common_vendor.wx$1.showToast({
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "set_privacy", data, "user", (res2) => {
              common_vendor.wx$1.showToast({
              ...
              if (res2.data.status == 200) {
                utils_js_api.uniRequest("POST", "get_this_user", {
                  "user_id": this.user_x.id
                }, "user", (res3) => {
              ...
              common_vendor.wx$1.showModal({
                ...
                success: (res2) => {
                  if (res2.confirm) {
                    ...
                    utils_js_api.uniRequest("POST", "modify_usertype", data, "user", (res3) => {
                      common_vendor.wx$1.showToast({
                        title: res3.data.message,
                        icon: "none",
                        duration: 700
                      ...
                      if (res3.data.status === 200) {
                        utils_js_api.uniRequest("POST", "refresh", { "my_id": this.user.id }, "user", (res4) => {
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "delete_user", data, "user", (res2) => {
              common_vendor.wx$1.showToast({
                title: res2.data.message,
                icon: "none",
                duration: 1e3
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "modify_TJTTer", data, "application", (res2) => {
              common_vendor.wx$1.showToast({
                title: res2.data.message,
                icon: "none",
                duration: 1e3
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: _ctx.user_x.profile_img
      }, _ctx.user_x.profile_img ? {
        b: _ctx.user_x.profile_img
      } : _ctx.user_x.gender == "男" ? {} : _ctx.user_x.gender == "女" ? {} : {}, {
        c: _ctx.user_x.gender == "男",
        d: _ctx.user_x.gender == "女",
        e: common_vendor.o((...args) => _ctx.avatar_operation && _ctx.avatar_operation(...args)),
        f: common_vendor.t(_ctx.user_x.username),
        g: common_vendor.t(_ctx.user_x.school),
        h: _ctx.user_x.organ
      }, _ctx.user_x.organ ? {
        i: common_vendor.t(_ctx.user_x.organ.organname)
      } : {}, {
        j: _ctx.user_x.hand
      }, _ctx.user_x.hand ? {
        k: common_vendor.t(_ctx.user_x.hand)
      } : {}, {
        l: _ctx.user_x.grip
      }, _ctx.user_x.grip ? {
        m: common_vendor.t(_ctx.user_x.grip)
      } : {}, {
        n: _ctx.user_x.particle
      }, _ctx.user_x.particle ? {
        o: common_vendor.t(_ctx.user_x.particle)
      } : {}, {
        p: common_vendor.t(_ctx.user_x.score),
        q: common_vendor.f(_ctx.actionList, (item, index, i0) => {
          return common_vendor.e({
        ...
        r: common_vendor.t(_ctx.user_x.gender),
        s: common_vendor.t(_ctx.user_x.address),
        t: common_vendor.t(_ctx.user_x.phone),
        v: common_vendor.t(_ctx.user_x.email),
        w: common_vendor.t(_ctx.user_x.school),
        x: common_vendor.t(_ctx.user_x.role),
        y: common_vendor.t(_ctx.user_x.stu_num),
        z: _ctx.user_x.organ
      }, _ctx.user_x.organ ? {
        A: common_vendor.t(_ctx.user_x.organ.organname)
      } : {}, {
        B: common_vendor.t(_ctx.user_x.hand),
        C: common_vendor.t(_ctx.user_x.grip),
        D: common_vendor.t(_ctx.user_x.blade),
        E: common_vendor.t(_ctx.user_x.forehand),
        F: common_vendor.t(_ctx.user_x.backhand),
        G: common_vendor.t(_ctx.user_x.particle),
        H: _ctx.user_x.usertype == "0"
      }, _ctx.user_x.usertype == "0" ? {} : {
        I: common_vendor.t(_ctx.user_x.usertype)
      }, {
        J: _ctx.user_x.privacy == 1
      }, _ctx.user_x.privacy == 1 ? {} : {}, {
        K: common_vendor.t(utils_js_utils.format_time(_ctx.user_x.join_time)),
        L: _ctx.user_x.is_TJTT == 0
      }, _ctx.user_x.is_TJTT == 0 ? {
        M: common_vendor.o((...args) => _ctx.modify_TJTTer && _ctx.modify_TJTTer(...args))
      } : {
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/page_subjec/user/user-detail.js.map
