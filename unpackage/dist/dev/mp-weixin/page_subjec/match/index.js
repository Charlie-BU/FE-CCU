...
const __default__ = {
  ...
  onLoad() {
    ...
    utils_js_api.uniRequest("POST", "match_list_current", null, "competition", (res) => {
  ...
  methods: {
    ...
    search() {
      ...
      utils_js_api.uniRequest("POST", "findMatchByName", data, "competition", (res) => {
        this.matches = res.data.matches;
        common_vendor.wx$1.hideToast();
      });
    },
    change(index) {
      ...
      if (index == 0) {
        ...
        utils_js_api.uniRequest("POST", "match_list_signed", { "my_id": this.user.id }, "competition", (res) => {
          this.matches = res.data.matches;
          common_vendor.wx$1.hideToast();
        });
      } else if (index == 2) {
        ...
        utils_js_api.uniRequest("POST", "match_list_history", null, "competition", (res) => {
          this.matches = res.data.matches;
          common_vendor.wx$1.hideToast();
        });
      } else if (index == 3) {
        ...
        utils_js_api.uniRequest("POST", "match_list_all", null, "competition", (res) => {
          this.matches = res.data.matches;
          common_vendor.wx$1.hideToast();
        });
      }
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "quit_match", data, "competition", (res2) => {
              common_vendor.wx$1.showToast({
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "hide_match", data, "competition", (res2) => {
              common_vendor.wx$1.showToast({
                title: res2.data.message,
                icon: "none",
                duration: 1e3
              ...
              if (res2.data.status == 200) {
                this.current = 0;
                utils_js_api.uniRequest("POST", "match_list_current", null, "competition", (res3) => {
      ...
      return common_vendor.e({
        ...
        g: common_vendor.f(_ctx.matches, (match, index, i0) => {
          return common_vendor.e({
            ...
            d: common_vendor.t(utils_js_utils.format_time(match.match_time)),
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/page_subjec/match/index.js.map
