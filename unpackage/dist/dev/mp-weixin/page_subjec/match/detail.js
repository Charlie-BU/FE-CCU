  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        c: common_vendor.t(utils_js_utils.format_time(_ctx.match.match_time)),
        ...
        i: common_vendor.t(utils_js_utils.format_time(_ctx.match.match_time)),
        ...
        s: common_vendor.t(utils_js_utils.format_time(_ctx.match.sign_start_time)),
        t: common_vendor.t(utils_js_utils.format_time(_ctx.match.sign_end_time)),
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/page_subjec/match/detail.js.map
