...
<script>
	...
	export default {
		...
		onLoad() {
			...
			uniRequest("POST", "get_info", null, "user", res => {
			...
			// 获取待回答问题
			uniRequest("POST", "get_unanswered_Qs", null, "application", res => {
		...
		methods: {
			change(index) {
				...
				if (index == 0) {
					...
					uniRequest("POST", "get_hidden_notices", null, "application", res => {
					...
					uniRequest("POST", "get_hidden_matches", null, "application", res => {
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "answer_question", data, "application", res => {
								wx.showToast({
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "delete_QA", data, "user", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "unhide_notice", data, "application", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "delete_notice", data, "application", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "unhide_match", data, "competition", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "delete_match", data, "competition", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
