								...
								wx.showModal({
									...
									success: res => {
										if (res.confirm) {
											...
											uniRequest("POST", "modify_user_profile_img", data, "user", res => {
												wx.showToast({
								...
								wx.showModal({
									...
									success: res => {
										if (res.confirm) {
											...
											uniRequest("POST", "delete_user_profile_img", data, "user", res => {
												wx.showToast({
													title: res.data.message,
													icon: "none",
													duration: 1000,
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "set_privacy", data, "user", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
			                    ...
			                    wx.showModal({
			                        ...
			                        success: res => {
			                            if (res.confirm) {
			                                ...
			                                uniRequest("POST", "modify_usertype", data, "user", res => {
			                                    wx.showToast({
			                                        title: res.data.message,
			                                        icon: "none",
			                                        duration: 700,
			                                    ...
			                                    if (res.data.status === 200) {
			                                        uniRequest("POST", "refresh", { "my_id": this.user.id }, "user", res => {
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "delete_user", data, "user", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "modify_TJTTer", data, "application", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
