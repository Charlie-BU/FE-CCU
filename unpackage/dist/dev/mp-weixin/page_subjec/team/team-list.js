...
const _sfc_main = {
  ...
  onLoad() {
    ...
    utils_js_api.uniRequest("POST", "get_teams", null, "competition", (res) => {
  ...
  methods: {
    ...
    search() {
      ...
      utils_js_api.uniRequest("POST", "findTeamByName", data, "competition", (res) => {
        this.teams = res.data.teams;
        this.team_length = res.data.team_length;
      });
    },
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "modify_member_max", data, "competition", (res2) => {
              common_vendor.wx$1.showToast({
              ...
              if (res2.data.status == 200) {
                utils_js_api.uniRequest("POST", "get_teams", null, "competition", (res3) => {
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "modify_match", data, "competition", (res2) => {
              common_vendor.wx$1.showToast({
                title: res2.data.message,
                icon: "none",
                duration: 1e3
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "delete_team", data, "competition", (res2) => {
              common_vendor.wx$1.showToast({
                title: res2.data.message,
                icon: "none",
                duration: 1e3
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    e: common_vendor.o((...args) => $options.add_team && $options.add_team(...args)),
    f: common_vendor.f($data.teams, (team, index, i0) => {
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/page_subjec/team/team-list.js.map
