...
const __default__ = {
  ...
  onLoad() {
    ...
    utils_js_api.uniRequest("POST", "get_score_logs", null, "competition", (res) => {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: _ctx.user.usertype == "K9" || _ctx.user.usertype == "K10" || _ctx.user.usertype == "K11"
        ...
        l: common_vendor.f(_ctx.score_logs, (score_log, index, i0) => {
          return common_vendor.e({
            ...
            A: common_vendor.t(utils_js_utils.format_time(score_log.time)),
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/page_subjec/log/score-log.js.map
