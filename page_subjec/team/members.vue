				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "add_member", data, "competition", res => {
								wx.showToast({
								...
								if (res.data.status == 200) {
									uniRequest("POST", "get_this_team", {team_id: this.team.id}, "competition", res => {
				...
				wx.showModal({
					...
					success: res => {
						if (res.confirm) {
							...
							uniRequest("POST", "remove_member", data, "competition", res => {
								wx.showToast({
									title: res.data.message,
									icon: "none",
									duration: 1000,
