...
const _sfc_main = {
  ...
  onLoad() {
    ...
    utils_js_api.uniRequest("POST", "get_users_by_join_time", null, "user", (res) => {
  ...
  methods: {
    ...
    search() {
      ...
      utils_js_api.uniRequest("POST", "findUserByName", data, "user", (res) => {
        this.users = res.data.users;
      });
    },
    add_user() {
      ...
      common_vendor.wx$1.showModal({
        ...
        success: (res) => {
          if (res.confirm) {
            ...
            utils_js_api.uniRequest("POST", "modify_score", data, "user", (res2) => {
              common_vendor.wx$1.showToast({
              ...
              if (res2.data.status == 200) {
                utils_js_api.uniRequest("POST", "get_users", null, "user", (res3) => {
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/page_subjec/user/user-list.js.map
